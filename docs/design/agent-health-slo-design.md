...
> health API/CLI). M43 adds synthetic probes (`hiveplane.probes`), approval
> analytics, plane `/metrics` (`PlaneMetrics`), and Grafana dashboards under
> `deploy/grafana/dashboards/` (fleet/health/cost/plane).
